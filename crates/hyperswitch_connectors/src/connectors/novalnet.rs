    ...
    for Novalnet
{
    ...
    // let minor_amount = MinorUnit::new(0);
    ...
    //     )?;
        ...
        // let connector_router_data = novalnet::NovalnetRouterData::from(( req));
        let connector_req = novalnet::NovalnetMandateRequest::try_from(req)?;
